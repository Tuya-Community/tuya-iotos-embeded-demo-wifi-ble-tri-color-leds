# Tuya IoTOS Embeded Demo WiFi & BLE three-color light
...
本 Demo 基于涂鸦智能云平台、涂鸦智能APP、IoTOS Embeded WiFi &Ble SDK，使用涂鸦WiFi/WiFi+BLE系列模组快速组建一个RGB三色调光灯的demo，实现手机远程控制灯光调色。
## 快速上手
